...
(function( $, window, document, undefined ) {
	...
	var __row_selector = function (settings, selector, opts) {
        ...
        var run = function (sel) {
            ...
            // of if the tr element Berhasil ditambah or not, so can't rely upon
    ...
    DataTable.models.oColumn = {
         ...
         *  @type function
         *  @param {element} nTd The TD node that Berhasil ditambah
    ...
    DataTable.defaults.column = {
         ...
         * element is available.
         *  @type function
         *  @param {element} td The TD node that Berhasil ditambah
