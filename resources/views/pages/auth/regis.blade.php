        ...
        <div class="col-md-6" style="margin-top:60px">
           <div class="container">
            <div class="card" style="border:none;">
                <div class="card-body">
                    <div class="container">
                        <h1 class="mt-3"  style="color: #a56d21">Sign up</h1>
                        <hr style="width: 60px">
                        <form role="form" method="POST" action="{{ route('redirectAuthRegister') }}">
                    {{-- <form class="mt-5"> --}}
                        @csrf
                        @if (session('message'))
                ...
                <div class="row my-3">
                    ...
                    <div class="col">
                        <div class="text-center">
                            <small style="font-size: 12px">or Sign up with</small>
                       </div>   
                    </div>
                    <div class="col">
                    ...
                    <div class="row">
                        ...
                        <div class="text-center mt-3">
                            <small class="text-center">Have Account? <a href="/login">Sign in</a></small>
                        </div>
                    </div>
                   </div>
                </div>
